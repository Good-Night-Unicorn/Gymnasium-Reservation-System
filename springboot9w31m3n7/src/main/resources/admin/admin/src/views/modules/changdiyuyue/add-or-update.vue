	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="场地类型" prop="changdileixing" >
					<el-input v-model="ruleForm.changdileixing" placeholder="场地类型" clearable  :readonly="ro.changdileixing"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="场地类型" prop="changdileixing" >
					<el-input v-model="ruleForm.changdileixing" placeholder="场地类型" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="预约时长" prop="yuyueshizhang" >
					<el-input-number v-model="ruleForm.yuyueshizhang" placeholder="预约时长" :disabled="ro.yuyueshizhang"></el-input-number>
				</el-form-item>
				...
				<el-form-item class="input" v-else-if="ruleForm.zongfeiyong" label="总费用" prop="zongfeiyong" >
			...
			<el-form-item v-else-if="ruleForm.yuyueneirong" label="预约内容" prop="yuyueneirong" >
				<span class="text">{{ruleForm.yuyueneirong}}</span>
			</el-form-item>
