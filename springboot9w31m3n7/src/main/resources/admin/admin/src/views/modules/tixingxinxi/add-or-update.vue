	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-else-if="ruleForm.tixingshijian" label="提醒时间" prop="tixingshijian" >
			...
			<el-form-item v-else-if="ruleForm.tixingneirong" label="提醒内容" prop="tixingneirong" >
				<span class="text">{{ruleForm.tixingneirong}}</span>
			</el-form-item>
