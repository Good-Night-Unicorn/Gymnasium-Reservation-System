<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"0px 0 0 195px","margin":"0","position":"relative","background":"#E7E7E7","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"border":"1px soild #F1F1F1","padding":"0 28px 0","margin":"0 0 10px 0","color":"#333","alignItems":"center","display":"flex","justifyContent":"space-between","top":"0","borderRadius":"10px","left":"40px","background":"#fff","width":"calc(100% - 50px)","fontSize":"16px","lineHeight":"90px","position":"inherit","zIndex":"1001","height":"90px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"10px","margin":"0px auto 0 40px","borderColor":"#3b6885","borderWidth":"0 0 0px 0","background":"#fff","width":"calc(100% - 50px)","fontSize":"16px","borderStyle":"solid","height":"40px"}' class="bread-crumbs"></bread-crumbs>
