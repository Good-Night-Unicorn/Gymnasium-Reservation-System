		...
		<view class="content">
			<view :style='{"minHeight":"100%","width":"100%","padding":"0","position":"relative","background":"#FFF8F5","height":"auto"}'>
				...
				<view :style='{"padding":"0 20rpx 40rpx 20rpx","borderRadius":"0 0 20rpx 20rpx","flexWrap":"wrap","background":"#F49971","flexDirection":"row","flex":"none","display":"flex","width":"100%","height":"auto"}'>
					<scroll-view scroll-x="true" class="category-one" :style='{"padding":"0","margin":"0","whiteSpace":"wrap","borderRadius":"0 0 20rpx 20rpx","background":"none","flexDirection":"column","flex":"none","display":"flex","width":"200rpx","height":"auto"}'>
					...
					<!-- 样式6 -->
					<view class="news-box6" :style='{"width":"calc(100% - 200rpx)","padding":"20rpx 24rpx 0","flexWrap":"wrap","flex":"auto","display":"flex","height":"auto"}'>
						<view @tap="onDetailTap(product)" v-for="(product,index) in list" :key="index" class="list-item" :style='{"width":"100%","padding":"8rpx 24rpx 8rpx 80rpx","margin":"0 0 20rpx","position":"relative","background":"#f7f7f7","height":"auto"}'>
							<view :style='{"padding":"0","margin":"-36rpx 0 0 0","borderColor":"red","color":"red","textAlign":"center","borderRadius":"100%","top":"50%","left":"0","borderWidth":"2rpx","width":"72rpx","lineHeight":"68rpx","fontSize":"28rpx","position":"absolute","borderStyle":"solid","height":"72rpx"}' class="num">
								<view style="width: 100%;height: 100%;position: absolute;left: 0;top: 0;" :style="{transform: 'rotate('+(-index*60)+'deg)'}" class="dian">
									<view :style='{"transform":"translateX(-50%)","borderRadius":"100%","top":"-8rpx","left":"50%","background":"red","width":"16rpx","position":"absolute","height":"16rpx"}' />
							...
							<view class="item-list-body" :style='{"width":"100%","margin":"0","height":"auto"}'>
								...
								<view :style='{"padding":"4rpx 20rpx","overflow":"hidden","color":"#666","maxHeight":"120rpx","width":"100%","lineHeight":"40rpx","fontSize":"28rpx"}' class="text ">{{product.introduction}}</view>
