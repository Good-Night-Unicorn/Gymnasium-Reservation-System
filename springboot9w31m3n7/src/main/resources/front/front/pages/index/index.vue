<template>
	<view class="content">
		<view :style='{"width":"100%","padding":"0 0 40rpx 0","background":"#FFF8F5","flexDirection":"column","display":"flex","height":"auto"}'>
			...
			<!-- 关于我们 -->
			<view :style='{"padding":"0 20rpx","margin":"40rpx 0 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","height":"auto","order":"2"}'>
				<view :style='{"padding":"0","margin":"0","color":"#000","alignItems":"center","background":"linear-gradient( 45deg, #F89A4E 0%, #FFCAB3 55%, #F89A4E 100%)","display":"flex","width":"100%","fontSize":"32rpx","position":"relative","justifyContent":"center","fontWeight":"600","height":"90rpx"}'>{{aboutUsDetail.title}}</view>
				...
				<view :style='{"padding":"20rpx","margin":"0","color":"#000000","background":"none","width":"100%","lineHeight":"2","fontSize":"28rpx"}' v-html="aboutUsDetail.content"></view>
				<view :style='{"border":"none","padding":"0","margin":"0","top":"0","textAlign":"center","background":"none","display":"none","width":"auto","lineHeight":"58rpx","position":"absolute","right":"40rpx","height":"58rpx"}' @tap="onDetailTap('aboutus',1)">
			...
			<!-- 系统简介 -->
			<view :style='{"padding":"0 20rpx","margin":"40rpx 0 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","height":"auto","order":"4"}'>
				<view :style='{"padding":"0","margin":"0","color":"#000","alignItems":"center","background":"linear-gradient( 45deg, #F89A4E 0%, #FFCAB3 55%, #F89A4E 100%)","display":"flex","width":"100%","fontSize":"32rpx","position":"relative","justifyContent":"center","fontWeight":"600","height":"90rpx"}'>{{systemIntroductionDetail.title}}</view>
				...
				<view :style='{"width":"100%","padding":"0","margin":"40rpx 0 0","flexWrap":"no-wrap","display":"flex","height":"auto"}'>
					<img :style='{"margin":"0","objectFit":"cover","borderRadius":"0","flex":1,"display":"block","height":"120rpx"}' v-if="systemIntroductionDetail.picture1" :src="baseUrl+systemIntroductionDetail.picture1">
					<img :style='{"margin":"0 10rpx","objectFit":"cover","flex":1,"display":"block","height":"120rpx"}' v-if="systemIntroductionDetail.picture2" :src="baseUrl+systemIntroductionDetail.picture2">
					<img :style='{"margin":"0 10rpx","objectFit":"cover","flex":1,"display":"block","height":"120rpx"}' v-if="systemIntroductionDetail.picture3" :src="baseUrl+systemIntroductionDetail.picture3">
				</view>
				<view :style='{"padding":"20rpx","margin":"0","color":"#000","background":"none","width":"100%","lineHeight":"2","fontSize":"28rpx"}' v-html="systemIntroductionDetail.content"></view>
				<view :style='{"border":"none","padding":"0","margin":"0","textAlign":"center","background":"none","display":"none","width":"auto","lineHeight":"58rpx","position":"absolute","right":"40rpx","height":"58rpx"}' @tap="onDetailTap('systemintro',1)">
					<text :style='{"color":"#fff","fontSize":"28rpx","lineHeight":"58rpx"}'>查看更多</text>
					<text class="icon iconfont " :style='{"color":"#A29068","fontSize":"24rpx"}'></text>
				</view>
				<view :style='{"width":"50%","background":"url(http://codegen.caihongy.cn/20201114/7856ba26477849ea828f481fa2773a95.jpg) 0% 0% / cover no-repeat","display":"none","height":"160rpx"}' />
				<view :style='{"width":"50%","background":"url(http://codegen.caihongy.cn/20201114/7856ba26477849ea828f481fa2773a95.jpg) 0% 0% / cover no-repeat","display":"none","height":"160rpx"}' />
			</view>
			...
			<!-- 商品列表 -->
			<!-- 新闻资讯 -->
			<view class="listBox news" :style='{"width":"100%","padding":"0 20rpx","margin":"40rpx 0 0","background":"none","order":"5"}'>
				<view class="title" :style='{"padding":"0 0 0 60rpx","margin":"0","background":"#F8824E","display":"flex","width":"100%","position":"relative","justifyContent":"start","height":"58rpx"}'>
					<view :style='{"fontSize":"32rpx","lineHeight":"58rpx","color":"#fff","fontWeight":"600"}'>公告资讯</view>
					<view :style='{"position":"absolute","right":"20rpx","alignItems":"center","top":"0","justifyContent":"center","display":"flex"}' @tap="onPageTap('news')">
					  ...
					  <text class="icon iconfont icon-jiantou25" :style='{"color":"#fff","fontSize":"28rpx"}'></text>
					</view>
				</view>
				<!-- 样式9 -->
				<view class="news-box6" :style='{"width":"100%","padding":"24rpx 20rpx","margin":"40rpx 0 0","borderRadius":"20rpx","background":"#F49971","height":"auto"}'>
					<view @tap="onNewsDetailTap(item.id)" v-for="(item,index) in news" :key="index" class="list-item" :style='{"width":"100%","padding":"8rpx 24rpx 8rpx 80rpx","margin":"0 0 20rpx","position":"relative","background":"#f7f7f7","height":"auto"}'>
						<view :style='{"padding":"0","margin":"-36rpx 0 0 0","borderColor":"#F49971","color":"#F49971","textAlign":"center","borderRadius":"100%","top":"50%","left":"8rpx","borderWidth":"2rpx","width":"72rpx","lineHeight":"68rpx","fontSize":"28rpx","position":"absolute","borderStyle":"solid","height":"72rpx"}' class="num">
							<view style="width: 100%;height: 100%;position: absolute;left: 0;top: 0;" :style="{transform: 'rotate('+(-index*60)+'deg)'}" class="dian">
								<view :style='{"transform":"translateX(-50%)","borderRadius":"100%","top":"-8rpx","left":"50%","background":"#F49971","width":"16rpx","position":"absolute","height":"16rpx"}'></view>
							</view>{{ index + 1 < 10 ? '0'+(index+1) : index+1 }}
						</view>
						<view class="item-list-body" :style='{"width":"100%","margin":"0","height":"auto"}'>
							<view :style='{"padding":"0 20rpx","overflow":"hidden","color":"#333","width":"100%","lineHeight":"1.5","fontSize":"28rpx","fontWeight":"600"}' class="title ">{{item.title}}</view>
							<view :style='{"padding":"0 20rpx","margin":"0","overflow":"hidden","color":"#666","maxHeight":"120rpx","width":"100%","lineHeight":"40rpx","fontSize":"28rpx"}' class="text">{{item.introduction}}</view>
...
<style lang="scss" scoped>
	...
	.menu_view {
		...
		margin: 0;
		background: url(http://codegen.caihongy.cn/20250205/d40484f9938e4bc9bc20f3901aa2cbb6.png) no-repeat bottom center / 710rpx 134rpx;
		display: flex;
		width: 100%;
