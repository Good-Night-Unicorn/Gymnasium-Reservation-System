						...
						<block v-for="(product,index) in list" :key="index">
							<view v-if="index%2==0" class="list-item" :style='{"padding":"0 0 20rpx 0","margin":"0 0 20rpx","borderColor":"#9F6045","flexWrap":"wrap","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
								...
								<view :style='{"width":"100%","padding":"8rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
									<view :style='{"border":"2rpx solid #F8824E","alignItems":"center","color":"#F8824E","background":"#FEF1EC","display":"flex","width":"160rpx","justifyContent":"center","height":"50rpx"}' v-if="(userid && isAuth('config','修改')) || (!userid && isAuthFront('config','修改'))" @tap.stop.proevent="onUpdate" :data-row="product">
									...
									<view :style='{"border":"2rpx solid #F8824E","alignItems":"center","color":"#F8824E","background":"#FEF1EC","display":"flex","width":"160rpx","justifyContent":"center","height":"50rpx"}' v-if="(userid && isAuth('config','删除')) || (!userid && isAuthFront('config','删除'))" @tap.stop.proevent="onDelete" :data-row="product">
								...
								<!-- #ifndef MP-WEIXIN -->
								<view :style='{"width":"100%","padding":"8rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
									<view :style='{"border":"2rpx solid #F8824E","alignItems":"center","color":"#F8824E","background":"#FEF1EC","display":"flex","width":"160rpx","justifyContent":"center","height":"50rpx"}' v-if="(userid && isAuth('config','修改')) || (!userid && isAuthFront('config','修改'))" @tap.stop.proevent="onUpdateTap(product)">
										<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"inherit","display":"inline-block"}' class="cuIcon-edit"></text>
										<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"inherit","display":"inline-block"}'>修改</text>
									</view>
									<view :style='{"border":"2rpx solid #F8824E","alignItems":"center","color":"#F8824E","background":"#FEF1EC","display":"flex","width":"160rpx","justifyContent":"center","height":"50rpx"}' v-if="(userid && isAuth('config','删除')) || (!userid && isAuthFront('config','删除'))" @tap.stop.proevent="onDeleteTap(product.id)">
										<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"inherit","display":"inline-block"}' class="cuIcon-delete"></text>
										<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"inherit","display":"inline-block"}'>删除</text>
									</view>
								</view>
