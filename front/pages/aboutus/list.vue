	...
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
		<view class="content">
			<view :style='{"minHeight":"100%","width":"100%","padding":"0","position":"relative","background":"#FFF8F5","height":"auto"}'>
						...
						<block v-for="(product,index) in list" :key="index">
							<view v-if="index%2==0" class="list-item" :style='{"padding":"0 0 20rpx 0","margin":"0 0 20rpx","borderColor":"#9F6045","flexWrap":"wrap","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
								...
								<view :style='{"width":"100%","padding":"8rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
									<view :style='{"border":"2rpx solid #F8824E","alignItems":"center","color":"#F8824E","background":"#FEF1EC","display":"flex","width":"160rpx","justifyContent":"center","height":"50rpx"}' v-if="(userid && isAuth('aboutus','修改')) || (!userid && isAuthFront('aboutus','修改'))" @tap.stop.proevent="onUpdate" :data-row="product">
									...
									<view :style='{"border":"2rpx solid #F8824E","alignItems":"center","color":"#F8824E","background":"#FEF1EC","display":"flex","width":"160rpx","justifyContent":"center","height":"50rpx"}' v-if="(userid && isAuth('aboutus','删除')) || (!userid && isAuthFront('aboutus','删除'))" @tap.stop.proevent="onDelete" :data-row="product">
								...
								<!-- #ifndef MP-WEIXIN -->
								<view :style='{"width":"100%","padding":"8rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
									<view :style='{"border":"2rpx solid #F8824E","alignItems":"center","color":"#F8824E","background":"#FEF1EC","display":"flex","width":"160rpx","justifyContent":"center","height":"50rpx"}' v-if="(userid && isAuth('aboutus','修改')) || (!userid && isAuthFront('aboutus','修改'))" @tap.stop.proevent="onUpdateTap(product)">
										<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"inherit","display":"inline-block"}' class="cuIcon-edit"></text>
										<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"inherit","display":"inline-block"}'>修改</text>
									</view>
									<view :style='{"border":"2rpx solid #F8824E","alignItems":"center","color":"#F8824E","background":"#FEF1EC","display":"flex","width":"160rpx","justifyContent":"center","height":"50rpx"}' v-if="(userid && isAuth('aboutus','删除')) || (!userid && isAuthFront('aboutus','删除'))" @tap.stop.proevent="onDeleteTap(product.id)">
										<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"inherit","display":"inline-block"}' class="cuIcon-delete"></text>
										<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"inherit","display":"inline-block"}'>删除</text>
									</view>
								</view>
				...
				<button :style='{"border":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,.3)","margin":"20rpx 20rpx 0 ","color":"rgb(255, 255, 255)","bottom":"0","right":"0","outline":"none","borderRadius":"20rpx","background":"#F66725","width":"120rpx","lineHeight":"70rpx","fontSize":"28rpx","position":"relative","height":"70rpx","zIndex":"1"}' v-if="userid && isAuth('aboutus','新增')" class="add-btn" @click="onAddTap()">新增</button>
				<button :style='{"border":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,.3)","margin":"20rpx 20rpx 0 ","color":"rgb(255, 255, 255)","bottom":"0","right":"0","outline":"none","borderRadius":"20rpx","background":"#F66725","width":"120rpx","lineHeight":"70rpx","fontSize":"28rpx","position":"relative","height":"70rpx","zIndex":"1"}' v-if="!userid && isAuthFront('aboutus','新增')" class="add-btn" @click="onAddTap()">新增</button>
			</view>
		</view>
	</mescroll-uni>
</template>
