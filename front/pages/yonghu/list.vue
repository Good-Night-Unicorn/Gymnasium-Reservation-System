			...
			<view :style='{"minHeight":"100%","width":"100%","padding":"0","position":"relative","background":"#FFF8F5","height":"auto"}'>
				<view class="cu-bar bg-white search" :style='{"padding":"20rpx 24rpx","margin":"0","background":"linear-gradient( 270deg, #F5C18C 0%, #F77E4D 48%, #FFAF4F 100%)","display":"flex","width":"100%","position":"relative","height":"auto"}'>
					<view :style='{"border":"none","margin":"0","borderRadius":"20rpx","flex":"1","background":"none","lineHeight":"80rpx","position":"relative","height":"80rpx"}' class="search-form round">
						...
						<input placeholder-style="color: #000" :style='{"border":"0","padding":"12rpx 20rpx 12rpx 80rpx","color":"#000","borderRadius":"40rpx","background":"#fff","width":"100%","lineHeight":"80rpx","fontSize":"28rpx","height":"80rpx"}' v-model="searchForm.yonghuxingming" type="text" placeholder="用户姓名" ></input>
					</view>
					...
					<view v-if="list.length" class="list-box5" :style='{"padding":"24rpx","margin":"0","borderRadius":"40rpx","background":"#fff","flex":"auto","width":"calc(100% - 200rpx)","height":"auto"}'>
						<block v-for="(product,index) in list" :key="index">
							<view v-if="index%2==0" class="list-item" :style='{"padding":"0 0 20rpx 0","margin":"0 0 20rpx","borderColor":"#9F6045","flexWrap":"wrap","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
								<image :style='{"width":"168rpx","objectFit":"cover","borderRadius":"8rpx","display":"block","height":"auto"}' mode="aspectFill" v-if="preHttp(product.touxiang)" :src="product.touxiang"></image>
								<image :style='{"width":"168rpx","objectFit":"cover","borderRadius":"8rpx","display":"block","height":"auto"}' mode="aspectFill" v-else :src="product.touxiang?baseUrl+product.touxiang.split(',')[0]:''"></image>
					
								<view class="list-item-body" :style='{"width":"calc(100% - 168rpx)","padding":"0 0 0 20rpx","margin":"0","height":"auto"}' @tap="onDetailTap(product)">
									<view :style='{"padding":"0","margin":"0","color":"#333","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"600"}' class="title">{{product.yonghuxingming}}</view>
								...
								<view :style='{"width":"100%","padding":"8rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
									<view :style='{"border":"2rpx solid #F8824E","alignItems":"center","color":"#F8824E","background":"#FEF1EC","display":"flex","width":"160rpx","justifyContent":"center","height":"50rpx"}' v-if="(userid && isAuth('yonghu','修改')) || (!userid && isAuthFront('yonghu','修改'))" @tap.stop.proevent="onUpdate" :data-row="product">
									...
									<view :style='{"border":"2rpx solid #F8824E","alignItems":"center","color":"#F8824E","background":"#FEF1EC","display":"flex","width":"160rpx","justifyContent":"center","height":"50rpx"}' v-if="(userid && isAuth('yonghu','删除')) || (!userid && isAuthFront('yonghu','删除'))" @tap.stop.proevent="onDelete" :data-row="product">
								...
								<!-- #ifndef MP-WEIXIN -->
								<view :style='{"width":"100%","padding":"8rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
									<view :style='{"border":"2rpx solid #F8824E","alignItems":"center","color":"#F8824E","background":"#FEF1EC","display":"flex","width":"160rpx","justifyContent":"center","height":"50rpx"}' v-if="(userid && isAuth('yonghu','修改')) || (!userid && isAuthFront('yonghu','修改'))" @tap.stop.proevent="onUpdateTap(product)">
										<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"inherit","display":"inline-block"}' class="cuIcon-edit"></text>
										<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"inherit","display":"inline-block"}'>修改</text>
									</view>
									<view :style='{"border":"2rpx solid #F8824E","alignItems":"center","color":"#F8824E","background":"#FEF1EC","display":"flex","width":"160rpx","justifyContent":"center","height":"50rpx"}' v-if="(userid && isAuth('yonghu','删除')) || (!userid && isAuthFront('yonghu','删除'))" @tap.stop.proevent="onDeleteTap(product.id)">
										<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"inherit","display":"inline-block"}' class="cuIcon-delete"></text>
										<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"inherit","display":"inline-block"}'>删除</text>
									</view>
								</view>
				...
				<button :style='{"border":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,.3)","margin":"20rpx 20rpx 0 ","color":"rgb(255, 255, 255)","bottom":"0","right":"0","outline":"none","borderRadius":"20rpx","background":"#F66725","width":"120rpx","lineHeight":"70rpx","fontSize":"28rpx","position":"relative","height":"70rpx","zIndex":"1"}' v-if="userid && isAuth('yonghu','新增')" class="add-btn" @click="onAddTap()">新增</button>
				<button :style='{"border":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,.3)","margin":"20rpx 20rpx 0 ","color":"rgb(255, 255, 255)","bottom":"0","right":"0","outline":"none","borderRadius":"20rpx","background":"#F66725","width":"120rpx","lineHeight":"70rpx","fontSize":"28rpx","position":"relative","height":"70rpx","zIndex":"1"}' v-if="!userid && isAuthFront('yonghu','新增')" class="add-btn" @click="onAddTap()">新增</button>
